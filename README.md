...
1 thread writing chunks to files. Both chunk and file size are configurable. When file reaches pre-configured size, roll over.
...
We assume chunks are smaller than file sizes.
